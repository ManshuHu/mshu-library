...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(value,key) in storeTypes" :key="key">
          {{key}}:{{value}}
        </li>
      </ul>
      ...
      <ul>
        <li v-for="(value,key) in openingHours" :key="key">
          {{key}} --- open:{{value.open}} close:{{value.close}}
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <p :title="titleContent" :class="{active: isActive}"  :style="{color: textColor, fontSize: fontSize + 'px'}">George Orwell</p>
    </section>
  </div>
</template>
...
const storeTypes = computed(() =>
  bookstores.storeTypes
) 

const openingHours = computed(() =>
  bookstores.openingHours
) 
...
const countries = computed(() => 
  bookstores.countries
)

const titleContent = ref("George Orwell")
